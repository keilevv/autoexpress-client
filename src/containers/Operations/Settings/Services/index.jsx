...
function ServicesSettingsContainer() {
  ...
  return (
    <div className="p-4 max-w-[calc(100vw-250px)]">
      {" "}
      ...
      <div className="overflow-x-auto">
        ...
        <Modal
          title={
            <div className="flex items-center gap-2 text-xl text-red-700">
              {editingService ? <EditOutlined /> : <FaTools />}
